 ...
 *
 */
class UserAgentGui extends JFrame {
	 ...
	 */
	UserAgentGui(UserAgent a) {

		super(a.getLocalName() + " monitor");
		...
		/*for (int si = 0; si < G.getStratNums(0); si++) {
			...
			b[si].addActionListener( new ActionListener() {
				...
				public void actionPerformed(ActionEvent ev) {
					...
					try {
						...
						JOptionPane.showMessageDialog(UserAgentGui.this, "Invalid values. " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE); 
