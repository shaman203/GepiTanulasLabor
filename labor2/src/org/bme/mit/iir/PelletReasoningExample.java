...
public class PelletReasoningExample {
    ...
    public PelletReasoningExample(String ontologyFilename) {
        ...
        // 
        // A classpath-ban szerepelnie kell a Pellet jar file-jainak:
        //   pellet-core.jar pellet-datatypes.jar pellet-explanation.jar, ...
    ...
    public static void main(String[] args) {
    	...
    	PelletReasoningExample p = new PelletReasoningExample(
