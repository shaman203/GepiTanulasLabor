 ...
 *
 */
public class JapBidderAgent extends Agent {
				  ...
				  if (msg != null) {
					  ...
					  // ...else this is about the auction of a given good.	
						  ...
						  try {
							  ...
							  if (myMoney > actualBid && !myAgent.getLocalName().equals(actualLeaderName)) {
		
								  ACLMessage reply = msg.createReply();
								  reply.setPerformative(ACLMessage.PROPOSE);
								  reply.setContent(Integer.toString(actualBid+1));
								  send(reply);
